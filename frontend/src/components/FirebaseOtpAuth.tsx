...
interface FirebaseOtpAuthProps {
  onAuthSuccess: (user: User) => void;
}

const FirebaseOtpAuth: React.FC<FirebaseOtpAuthProps> = ({ onAuthSuccess }) => {
    ...
    try {
      ...
      if (isSignUp) {
        ...
        if (!result.user.emailVerified) {
          showMessage('Please verify your email address first. Check your inbox for verification email.', 'warning');
          await sendEmailVerification(result.user);
          return;
        }
        showMessage('Email sign-in successful!', 'success');
        setTimeout(() => {
          onAuthSuccess(result.user);
        }, 1500);
      }
  ...
  const handleEmailVerificationCheck = async () => {
    if (auth.currentUser) {
      ...
      if (auth.currentUser.emailVerified) {
        ...
        showMessage('Email not verified yet. Please check your inbox and click the verification link.', 'warning');
      }
    }
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 flex items-center justify-center p-4">
      <div className="w-full max-w-xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">Sign in to start your quiz journey</p>
        </div>
                ...
                {!emailVerificationSent ? (
                  <>
                    <div className="flex justify-center mb-4">
                      <div className="bg-gray-100/50 rounded-xl p-1 flex">
                        <button
                  ...
                  <div className="text-center space-y-4">
                    ...
                    <div className="flex space-x-3 justify-center">
                      <button
                        ...
                        className="bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-6 rounded-xl transform hover:scale-105 transition-all duration-300"
                      >
                        I've Verified
                      </button>
                      <button
